			...
			<div className="d-flex">
				<div className="card bg-info bg-opacity-25 central-card">
					<div className="card-body">
						...
						<ol>
							<li>
								<span>Subscribe</span> to <a href={vpnLink}>ExpressVPN</a> then download and install the
								program.
							</li>
							<li>
								<span>Relocate</span> yourself to the hosting country.
							</li>
							<li>
								<span>Login</span> to an online streaming service or official broadcast app.
							</li>
							<li>
								<span>Enjoy</span> live streaming your favorite matches!
							</li>
						</ol>
					</div>
				</div>
